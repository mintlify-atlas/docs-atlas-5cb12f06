...
description: "Forge deploys as a skill into five AI agents — OpenCode, Claude Code, Cursor, Codex CLI, and Gemini — each with hooks tuned to its extension model."
---
