...
description: "relocate moves legacy code to the correct architectural layer. reforge restructures features and components to resolve violations, extract use cases, and fix dependency cycles."
---
...
| Flag | Effect |
|------|--------|
| `--dry-run` | Preview all naming violations without making any changes |
| `--fix-naming` | Correct naming violations automatically without prompting |
| `--skip-naming` | Skip naming detection and correction entirely |
