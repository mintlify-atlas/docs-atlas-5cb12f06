...
description: "inspect evaluates your project across 10 categories (180 total points) and returns a normalized 0–100 score with an A–F grade, identifying violations by severity."
---
...
| Graph | 20 | Architecture graph health: risk score, dependency health percentage, and rule violations (R1–R13) |
...
| **B** | 75–89 | Minor inconsistencies. Easy to correct. |
| **C** | 60–74 | Several violations. Requires structured work. |
| **D** | 45–59 | Architecture compromised. Migration needed. |
| **F** | < 45 | Project not yet migrated or widespread violations. |
