...
description: "Forge models backends in four mandatory domains — Platform, Features, Shared, and Infra — with the architecture graph as the single source of truth."
---
