---
title: "Code Patterns: Entities, Use Cases, Repositories, and Adapters"
sidebarTitle: "Patterns"
description: "Learn the canonical code patterns for every Forge artifact type — entities, use cases, repository interfaces, error types, events, HTTP adapters, and persistence adapters."
---
