...
description: "Forge selects one of three DI strategies — tsyringe, NestJS built-in DI, or manual constructor injection — based on your detected technology profile."
---
...
**Profiles using manual injection**: `express-postgres`, `fastify-mongodb`, `fastify-postgres`, `fastify-prisma`
